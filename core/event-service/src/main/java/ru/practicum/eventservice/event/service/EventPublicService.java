...
import ru.practicum.eventservice.event.model.EventSort;
...
public class EventPublicService {
    ...
    public EventFullDto getEventByIdTheRequest(Long eventId, String ip, String uri) {
        log.info("Получение события по ID для request: {}", eventId);
